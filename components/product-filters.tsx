          ...
          <div className="mt-3 flex flex-wrap gap-2">
            {selectedFilters.map((filter) => (
              <div
                ...
                className="flex items-center gap-1 bg-red-50 dark:bg-red-900/30 text-red-700 dark:text-red-400 px-2 py-1 rounded text-sm"
              >
                <span>
            ...
            {attributes.map((attribute) => (
              <div key={attribute.attribute_name} className="border-b border-gray-100 pb-4 last:border-b-0">
                <button
                  ...
                  className="flex items-center justify-between w-full text-left py-2 hover:text-red-600 dark:hover:text-red-400 font-medium text-sm text-gray-900 dark:text-gray-100 transition-colors"
                >
