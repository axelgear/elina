...
export default function CartModal({ isOpen, onClose, onCheckout }: CartModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
      <div className="relative w-full max-w-2xl bg-white dark:bg-gray-800 rounded-lg shadow-xl max-h-[90vh] overflow-hidden">
              ...
              {cartItems.map((item) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-medium text-gray-900 dark:text-gray-100 truncate">{item.item_name}</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Code: {item.item_code}</p>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Group: {item.item_group}</p>
